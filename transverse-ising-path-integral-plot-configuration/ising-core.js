/**
 * Simulating transverse field Ising model using discrete path integral
 */

/**
 * Metropolis method for the discrete path integral of transverse field Ising model
 */
class MPIsing {
    constructor(J, h, site_list, inverse_list, neighbor_list) {
        ...
        // Estimate the initial state according to the direction of h 
        if (h >= 0) {
